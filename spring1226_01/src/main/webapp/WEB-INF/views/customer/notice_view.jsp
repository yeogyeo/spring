				...
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="day">
								<p class="txt">작성일
									<span>
										<fmt:formatDate value="${map.bdto.bdate}" pattern="yy.MM.dd"/> 
									</span>
								</p>
							</div>
						</div>
						...
						<div class="viewContents">
							<div style="white-space: pre">${map.bdto.bcontent}</div>
							<br><br>
					...
					<div class="replyBox">
						...
						<c:forEach var="cdto" items="${map.list}">
							<ul>
								<li class="name">${cdto.id} <span><fmt:formatDate value="${cdto.cdate}" pattern="[yyyy-MM-dd HH:mm:ss]"/></span></li>
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>
								...
								<li><a href="#" class="nbtnbig">답글달기</a></li>
