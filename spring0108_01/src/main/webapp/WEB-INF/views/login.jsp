...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=f532cdf36f0f1095000075065a77f69b&redirect_uri=http://localhost:8000/kakao/oauth"><li class="kakao"></li></a>
      <li class="naver"></li>
