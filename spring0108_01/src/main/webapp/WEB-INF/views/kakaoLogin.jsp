...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=fe714f17477232187f3fb8741b56d8bd&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code">
      <li class="kakao"></li>
      </a>
      <li class="naver"></li>
