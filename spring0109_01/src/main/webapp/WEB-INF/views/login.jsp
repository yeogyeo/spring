...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=d1133ac60217e365da67d276a1313be3&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code" style="text-decoration:none;">
         <li class="kakao"></li>
      </a>
      <li class="naver"></li>
